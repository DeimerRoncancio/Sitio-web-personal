...
export default function Droppable({ children, parent, items }) {
  ...
  return (
    <div ref={ref} className={`theme-text w-full h-full text-white after:shadow-cyan-800/50 after:inset-0
      ...
      {parent === "droppable"
        ? (<div className="h-full w-full overflow-y-auto">
            <div className="theme-drop-header w-full flex bg-[#111621] p-4 border-b border-[#2a3852] sticky top-0 z-20 items-center">
              <div className="theme-drop-icon bg-[#1d5771] text-2xl p-2 rounded-xl mr-5 text-[#0fc6f8]">
                {item?.icon}
              </div>
              <div>
