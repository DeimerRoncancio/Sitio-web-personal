...
export default function NavBar({ items, currentView, changeView }) {
  ...
  return (
    <div className="theme-nav-bar mobile-nav-bar grid grid-cols-[max-content_1fr] xl:!grid-cols-3 border-b px-3 xs:px-8 py-[11px]">
      <div className="flex min-w-0">
        ...
        <div className='theme-nav-title mobile-nav-title flex items-center text-sm xs:text-base font-medium pl-3 xs:pl-5 min-w-0'>
      ...
      <div className="mobile-nav-actions flex flex-row items-center justify-end space-x-4 pr-[2px]">
        <div className="hidden xs:flex flex-row items-center justify-end space-x-4 pr-[2px]">
          <button type="button" className='nav-button flex space-x-2 items-center'
            ...
            <p className="theme-muted hidden sm:block text-sm">Cambiar Vista</p>
          </button>
