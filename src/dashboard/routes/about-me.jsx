    ...
    <div className="dropable-zone-container flex sm:h-[calc(100%-77px)] items-center">
      <div className="flex flex-col gap-7 animation-fadeInUp">
        ...
        <div className="flex flex-wrap gap-3 text-xs xs:text-sm xs:font-medium">
          <a
            className="inline-flex items-center gap-2 rounded-xl border border-cyan-500/60 bg-[#162233] px-1 py-2 xs:px-4 xs:py-2 font-medium text-cyan-200 transition-colors duration-200 hover:bg-[#1b2b41]"
          ...
          <a
            className="inline-flex items-center gap-2 rounded-xl border border-[#2a3852] bg-[#171e2c] px-1 py-2 xs:px-4 xs:py-2 font-medium text-[#e6ebf2] transition-colors duration-200 hover:bg-[#1b2435]"
            href="https://www.linkedin.com/in/deimer-roncancio/"
            target="_blank"
            rel="noreferrer"
          >
            <svg className="h-3 w-3 xs:h-4 xs:w-4" fill="currentColor" viewBox="0 0 24 24">
