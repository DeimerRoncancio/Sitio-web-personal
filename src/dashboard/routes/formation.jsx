      ...
      <div className="max-w-3xl space-y-10">
        ...
        <div className="relative border-l-2 border-[#2a3852] ml-4 md:ml-6 space-y-12 pb-4">
          <div className="relative pl-8 md:pl-12">
            <div className="absolute -left-[25px] top-0 bg-[#151c2c] border-4 border-[#7d1ef8] rounded-full p-2">
          ...
          <div className="relative pl-8 md:pl-12 pt-4">
            ...
            <p className="text-[#979fa1] mt-2">
              Cursos profesionales que respaldan mis habilidades técnicas.
            </p>
          </div>

          <div className="relative pl-8 md:pl-12">
            <div className="absolute -left-[19px] top-1 bg-[#151c2c] border-2 border-[#6DB33F] rounded-full p-2">
